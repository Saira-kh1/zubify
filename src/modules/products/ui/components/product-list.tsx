...
import { useProductFiters } from "../../hooks/use-product-filters";
...
export const ProductList = ({ category  }: Props) =>{
    const [filters] = useProductFiters();
    ...
    if(data.pages?.[0]?.docs.length === 0){
        ...
        p-8 flex-col gap-y-4 bg-white w-full rounded-lg">
            <InboxIcon />
